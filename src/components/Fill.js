                ...
                <div className="form-bottom" id="form-bottom-fill">
                    <ul>
                        <li className="FullName">
                            ...
                            <input onKeyUp={this.onChangeHandler} placeholder="Ej: Sally Hill" id="fullName" type="text" name="FullName" required />
                        </li>
                        <li className="job">
                            <label htmlFor="job">Puesto<span>*</span></label>
                            <input onKeyUp={this.onChangeHandler} placeholder="Ej: Front-End unicorn" id="job" type="text" name="job" required />
                        </li>
                        ...
                        <li className="email">
                            ...
                            <input onKeyUp={this.onChangeHandler} placeholder="Ej: sally-hill@gmail.com" id="email" type="email" name="email" required />
                            <ErrorMessage id="error-email" errorText='Introduce un email válido.' />
                        </li>
                        <li className="tel">
                            <label htmlFor="phone">Teléfono</label>
                            <input onKeyUp={this.onChangeHandler} placeholder="Ej: 555-55-55-55" id="phone" type="tel" name="phone" required />
                            <ErrorMessage id="error-phone" errorText='Introduce un teléfono válido.' />
                        </li>
                        <li className="linkedin">
                            <label htmlFor="linkedin">Linkedin<span>*</span></label>
                            <input onKeyUp={this.onChangeHandler} placeholder="sally-hill" id="linkedin" type="text" name="linkedin" required />
                        ...
                        <li className="github">
                            ...
                            <input onKeyUp={this.onChangeHandler} placeholder="sally-hill" id="github" type="text" name="github" required />
