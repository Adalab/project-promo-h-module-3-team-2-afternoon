...
class Palette extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <input onChange={this.props.onChangeHandler} id={`palette${this.props.inputValue}`} type="radio" name="palette" value={this.props.inputValue} defaultChecked={this.props.checked}/>
